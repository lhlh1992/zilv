 ...
 */
package com.liu.mvc.dao.dicitem;
...
public interface DicitemMapper  {
     ...
     */
    List<DicItem> selectDicitem(@Param("code") String code);
    ...
    int insertDicItem(DicItem dicitem);
 	...
 	int deleteDicitem(String dic_type_code);
 	
 	int deleteDicitemAll(String code);
